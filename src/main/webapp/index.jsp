...
<body>
		...
		<div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
			...
			<div class="layui-tab-content">
				<div class="layui-tab-item layui-show">
					<iframe src='/rc/showWelcome.do' frameborder="0" scrolling="yes"
	...
	<!-- 底部开始 -->
	<div class="footer">
		<div class="copyright">刘陈虎©2020 前端：x-admin v2.3
			后端：刘陈虎-java EE项目</div>
	</div>
	<!-- 底部结束 -->
